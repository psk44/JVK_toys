...
class ToysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create toy" do
    assert_difference("Toy.count") do
      post toys_url, params: { toy: { description: @toy.description, name: @toy.name, price: @toy.price, toy_type_id: @toy.toy_type_id } }
    end
  ...
  test "should update toy" do
    patch toy_url(@toy), params: { toy: { description: @toy.description, name: @toy.name, price: @toy.price, toy_type_id: @toy.toy_type_id } }
